                        ...
                        child: Wrap(
                          ...
                          children: [
                            GlassedCard(
                              ...
                              title: "Arduino (AVR)",
                              description: "Morgana's extensor for AVR assembly has been implemented.",
                            ),
                            GlassedCard(
                              asset: 'assets/xtensa.jpg',
                              icon: Icons.memory_rounded,
                              title: "Tensilica (xTensa)",
                              description: "Morgana's extensor for xTensa assembly has been implemented.",
                            ),
                            GlassedCard(
                              asset: 'assets/x86_64.jpg',
                              icon: Icons.memory_rounded,
                              title: "Intel/AMD (x86_64)",
                              description: "Morgana's extensor for x86_64 assembly has been implemented.",
                            ),
                            GlassedCard(
                              asset: 'assets/arm.png',
                              icon: Icons.memory_rounded,
                              title: "Qualcomm ... (ARM)",
                              description: "Morgana's extensor for ARM assembly has been implemented.",
                            ),
                            GlassedCard(
                              asset: 'assets/risc-v.png',
                              icon: Icons.memory_rounded,
                              title: "SiFive ... (Risc-V)",
                              description: "Morgana's extensor for Ricv-V assembly has been implemented.",
                            )
                          ],
                        ),
                      ),
