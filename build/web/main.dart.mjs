...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1520: (o, p) => p in o,
      _1521: (o, p) => o[p],
      _1538: () => new AbortController(),
      _1539: x0 => x0.abort(),
      _1540: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1541: (x0,x1) => globalThis.fetch(x0,x1),
      _1542: (x0,x1) => x0.get(x1),
      _1543: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1543(f,arguments.length,x0,x1,x2) }),
      _1544: (x0,x1) => x0.forEach(x1),
      ...
      _3513: () => globalThis.window,
      _3575: x0 => x0.navigator,
